...
//   static final String DEL_PATH = "org/unesco/jisis/dataentryexdl/delete.png";
   ...
   public DataEntryTopComponent(IDatabase db) {
      ...
      fontSize_ = new FontSize(DEFAULT_FONT_SIZE);
...
//      btnDel.setIcon(new ImageIcon(ImageUtilities.loadImage(DEL_PATH, true)));
    ...
    */
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(tbtnShow, "Show");
        tbtnShow.setToolTipText("Show Empty Fields");
        tbtnShow.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        tbtnShow.setFocusable(false);
        tbtnShow.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        tbtnShow.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        tbtnShow.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tbtnShowActionPerformed(evt);
            }
        });
        toolbarOptions.add(tbtnShow);

        buttonGroup1.add(tbtnHide);
        org.openide.awt.Mnemonics.setLocalizedText(tbtnHide, "Hide");
        tbtnHide.setToolTipText("Hide Empty Fields");
        tbtnHide.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        tbtnHide.setFocusable(false);
        tbtnHide.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        tbtnHide.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        tbtnHide.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tbtnHideActionPerformed(evt);
            }
        });
        toolbarOptions.add(tbtnHide);

        org.openide.awt.Mnemonics.setLocalizedText(lblShowHide, "Empty Fields");
        toolbarOptions.add(lblShowHide);

        sliderFont.setMaximum(32);
        sliderFont.setMinimum(10);
        sliderFont.setToolTipText("Change Font Size of Data Text Box");
        sliderFont.setValue(14);
        sliderFont.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, "Font Size:");
        ...
        controlPanelLayout.setHorizontalGroup(
            ...
            .addGroup(controlPanelLayout.createSequentialGroup()
                ...
                .addGroup(controlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(controlPanelLayout.createSequentialGroup()
                        .addComponent(toolbarOptions, javax.swing.GroupLayout.PREFERRED_SIZE, 474, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(sliderFont, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void cmbWKSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbWKSActionPerformed
        ...
        /**
         * Don't know why these statements where introduced !!!!!
         * Commented
         */
//        if (wksName.equals("Default worksheet")) {
//            wksName = db_.getDbName();
//        }
        try {
...
//  }
    ...
    private void btnCopyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCopyActionPerformed
        ...
        copyRec_ = Record.newInstance(currRec_);

    }//GEN-LAST:event_btnCopyActionPerformed

    private void btnPasteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPasteActionPerformed
        /**
         * mfn will be 0 for a new record or current record mfn
         */
        long mfn = currRec_.getMfn();
        if (copyRec_ != null) {
            copyRec_.setMfn(mfn);
   ...
   private void btnValidationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValidationActionPerformed
    ...
    private void sliderFontStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderFontStateChanged
       ...
       int fontSize = sliderFont.getValue();
       editPanel_.changeFontSize(fontSize);
       fontSize_.setFontSize(fontSize);
    ...
    *                 updating, or empty data if we are creating a new record.
    */
   ...
   private void setRecord(IRecord record) {
      if (record != null) {
         ...
         currRec_ = record;
         /**
          * We only lock record if updating (mfn different than 0)
          */
         if (currRec_.getMfn() != 0) {
            try {
         ...
         if (fontSize_.getFontSize() != DEFAULT_FONT_SIZE) {
            editPanel_.changeFontSize(fontSize_.getFontSize());
         }
   ...
   /**
    * Override to check if record was modified and saved before hidding
    */
   @Override
   ...
   protected void componentShowing() {
      ...
      if (currRec_ != null && mfn> 0) {
          if (mfn != currRec_.getMfn()) {
              try {
                  IRecord record =  db_.getRecordCursor(mfn);
                  /**
                   * Note: setRecord will take care of unlocking the current record before
                   * displaying the new one. And will set currRec_
                   */
                  setRecord(record);
              } catch (DbException ex) {
                  Exceptions.printStackTrace(ex);
   ...
   private boolean checkModifiedRecordSaved() {
      ...
      if (editPanel_.isRecordModified()) {
         ...
         if (option == NotifyDescriptor.CANCEL_OPTION || option == NotifyDescriptor.NO_OPTION) {
            // Do nothing
            return false;
