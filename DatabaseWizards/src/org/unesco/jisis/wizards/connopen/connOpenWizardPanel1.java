...
public class connOpenWizardPanel1 implements WizardDescriptor.Panel {
    ...
    public void readSettings(Object settings) {
        //not implemented
        //there is only one step in this wizard
    }
    ...
    public void storeSettings(Object settings) {
        ...
        wd.putProperty("hostname", hostname);
        wd.putProperty("port", port);
        wd.putProperty("username", username);
        wd.putProperty("password", password);
    }
