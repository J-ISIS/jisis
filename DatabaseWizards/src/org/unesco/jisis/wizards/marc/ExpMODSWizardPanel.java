 ...
 * @author jc_dauphin
 */
public class ExpMODSWizardPanel implements WizardDescriptor.Panel {
    ...
    public Component getComponent() {
        if (component == null) {
            component = new ExpMODSVisualPanel();
        }
        return component;
    }
    ...
    public void storeSettings(Object settings) {
        ...
        ExpMODSVisualPanel panel = (ExpMODSVisualPanel) getComponent();
