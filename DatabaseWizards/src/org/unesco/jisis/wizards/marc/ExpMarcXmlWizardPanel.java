 ...
 * @author jc_dauphin
 */
public class ExpMarcXmlWizardPanel implements WizardDescriptor.Panel {
    ...
    public Component getComponent() {
        if (component == null) {
            component = new ExpMarcXmlVisualPanel();
        }
        return component;
    }
    ...
    public void storeSettings(Object settings) {
      ...
      ExpMarcXmlVisualPanel panel = (ExpMarcXmlVisualPanel) getComponent();
      File file = new File(panel.getSelectedFile());
      wd.putProperty("selectedFile", file);
      String marcXmlFile     = panel.getSelectedFile();
      ...
      wd.putProperty("marcXmlFile", marcXmlFile);
