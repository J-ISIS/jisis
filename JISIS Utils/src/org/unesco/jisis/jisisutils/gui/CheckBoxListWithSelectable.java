                 ...
                 */
                public class CheckBoxListWithSelectable extends JList implements 
                        ItemSelectable {
                    ...
                    public ListCellRenderer getCellRenderer() {
                        if (_listCellRenderer != null) {
                            _listCellRenderer.setActualListRenderer(super 
                                    .getCellRenderer());
                        ...
                        for (int i = 0; i < getModel().getSize(); i++) {
                            ...
                            if (elementAt instanceof  Selectable) {
                                ...
                                if (selectable instanceof  DefaultSelectable) {
                                    elementAt = ((DefaultSelectable) selectable)
                                            .getObject();
                                }
                                if (selected.get(elementAt) != null) {
                                    selectable.setSelected(true);
                                    fireItemStateChanged(new ItemEvent(this ,
                                            ItemEvent.ITEM_STATE_CHANGED, selectable,
                                            ItemEvent.SELECTED));
                                    ...
                                    if (selectable.isSelected()) {
                                        ...
                                        fireItemStateChanged(new ItemEvent(this ,
                                                ...
                                                selectable, ItemEvent.DESELECTED));
                                    }
                                }
                            }
                        }
                        ...
                        for (int i = 0; i < dataModel.getSize(); i++) {
                            if (!(dataModel.getElementAt(i) instanceof  Selectable)) {
                                throw new IllegalArgumentException(
                                        "The ListModel contains an element which is not an instance of Selectable at index "
                                                + i + ".");
                            }
                        }
                        return dataModel;
                        ...
                        protected void toggleSelections() {
                            ...
                            for (int index : indices) {
                                ...
                                if (element instanceof  Selectable
                                        && ((Selectable) element).isEnabled()) {
                                    ((Selectable) element).invertSelected();
                                    boolean selected = ((Selectable) element)
                                            .isSelected();
                                    _list.fireItemStateChanged(new ItemEvent(_list,
                                            ItemEvent.ITEM_STATE_CHANGED, element,
                            ...
                            if (listeners[i] == ItemListener.class) {
                                ...
                                if (e == null) {
                                    e = new ItemEvent(CheckBoxListWithSelectable.this ,
                                            ItemEvent.ITEM_STATE_CHANGED, event
                                                    .getItem(), event.getStateChange());
                                }
                    ...
                    public Object[] getSelectedObjects() {
                        ...
                        for (int i = 0; i < getModel().getSize(); i++) {
                            ...
                            if (elementAt instanceof  Selectable) {
                                ...
                                if (selectable.isSelected()) {
                                    if (selectable instanceof  DefaultSelectable) {
                                        elements.add(((DefaultSelectable) selectable)
                                                .getObject());
                                    } else {
