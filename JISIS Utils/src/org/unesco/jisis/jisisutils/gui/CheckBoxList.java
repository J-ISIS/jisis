...
public class CheckBoxList extends JList {
   ...
   protected void init() {
      ...
      SwingUtils.insertMouseListener(this, _handler, 0);
   ...
   @Override public ListCellRenderer getCellRenderer() {
   ...
   protected static class Handler
           implements MouseListener, KeyListener, ListSelectionListener, PropertyChangeListener,
                      ListDataListener {
   ...
   public void setCheckBoxEnabled(boolean checkBoxEnabled) {
      if (checkBoxEnabled != _checkBoxEnabled) {
         Boolean oldValue = _checkBoxEnabled
                            ? Boolean.TRUE
                            : Boolean.FALSE;
         Boolean newValue = checkBoxEnabled
                            ? Boolean.TRUE
                            : Boolean.FALSE;
   ...
   public void setCheckBoxListSelectionModel(
