...
public final class BalancedMergeSort implements FileSort
{
        ...
        throws FileNotFoundException, IOException
    {
        ...
        while(! allDone)
        {
            ...
            {
                //
                //  Pull in a few records, put them into the List
                ...
                //
                //  Sort the List then write it out to the
                //  appropriate A file.
                //
                QuicksortList.execute(v, rInfo.getComparator()) ;
                for (int j = 0 ; j < v.size() ; j++)
                {
                    writers[i].writeRecord(v.get(j)) ;
                }
            }
        }
        //
        ...
        throws FileNotFoundException, IOException
    {
        ...
        //
        //  We make use of an array which hold the next Record for each
