...
public class HistoryTextField extends JTextField {
    ...
    *
    * @param name The history model name
    * @param instantPopups If true, selecting a value from the history popup
    * will immediately fire an ActionEvent. If false, the user will have to
    * press 'Enter' first
    *
    * @since jEdit 2.2pre5
    */
   ...
   /**
    * Sets if selecting a value from the popup should immediately fire an
    * ActionEvent.
    *
    * @since jEdit 4.0pre3
    */
   ...
   /**
    * Returns if selecting a value from the popup should immediately fire an
    * ActionEvent.
    *
    * @since jEdit 4.0pre3
    */
   ...
   /**
    * Sets if pressing Enter should automatically add the currently entered text
    * to the history.
    *
    * @since jEdit 4.0pre3
    */
   ...
   /**
    * Returns if pressing Enter should automatically add the currently entered
    * text to the history.
    *
    * @since jEdit 4.0pre3
    */
      ...
      switch (evt.getID()) {
         case MouseEvent.MOUSE_PRESSED:
            ...
            if (evt.getX() >= getWidth() - insets.right
                    || MiscUtilities.isPopupTrigger(evt)) {
