...
//      btnLast.setIcon(new ImageIcon(ImageUtilities.loadImage(DOUBLE_RIGHT_PATH, true)));
      ...
      try {
         ...
         long recordCount = db_.getRecordsCount();
...
//       }
    ...
    */
    ...
    private void initComponents() {
        ...
        btnMarkMenu.setToolTipText("Access the Mark Menu");
        btnMarkMenu.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        chkMarkRecord.setFocusable(false);
        chkMarkRecord.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        chkMarkRecord.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblRecordCount, "Record Count:");

        txtRecordCount.setEditable(false);
        txtRecordCount.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtRecordCount.setMaximumSize(new java.awt.Dimension(100, 2147483647));
        txtRecordCount.setPreferredSize(new java.awt.Dimension(40, 20));
        txtRecordCount.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtRecordCountActionPerformed(evt);
            }
        });
        ...
        ctrlPanelLayout.setHorizontalGroup(
            ...
            .addGroup(ctrlPanelLayout.createSequentialGroup()
                ...
                .addGroup(ctrlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtRecordCount, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(ctrlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblMaxMfn)
                    .addComponent(txtMaxMfn, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                ...
                .addGroup(ctrlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(ctrlPanelLayout.createSequentialGroup()
                        .addGroup(ctrlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(ctrlPanelLayout.createSequentialGroup()
                                .addComponent(lblRecordCount, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtRecordCount, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(ctrlPanelLayout.createSequentialGroup()
                                .addComponent(lblMaxMfn)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtMaxMfn, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(12, 12, 12))))
        );
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(ctrlPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 1048, Short.MAX_VALUE)
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        mainPanelLayout.setVerticalGroup(
            mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addComponent(ctrlPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(webPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 558, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//            }
    ...
    private void txtRecordCountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtRecordCountActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtRecordCountActionPerformed
...
//   }
   ...
   public void update(Observable arg0, Object arg1) {
      ...
      if (db_.databaseHasChanged()) {
         try {
            long maxMFN = db_.getLastMfn();
            currentMfn_ = db_.getCurrentRecordMfn();
            long recordCount = db_.getRecordsCount();
            if (recordCount == 0) {
            ...
            assert(currentMfn_ >0 && currentMfn_ < maxMFN);
