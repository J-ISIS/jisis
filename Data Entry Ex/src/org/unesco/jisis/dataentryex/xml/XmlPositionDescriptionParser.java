 ...
 * @author jcd
 */
public class XmlPositionDescriptionParser  extends XMLItemParser {

   public XmlPositionDescriptionParser(IXMLReaderMediator med) {
    ...
    protected void copyBuffer() {
        XmlFixedFieldsReaderMediator med = (XmlFixedFieldsReaderMediator) med_;
         med.setPositionsDescription(buffer_.toString().trim());
