 ...
 * @author jcd
 */
class XmlCodeParser extends XMLItemParser {

   public XmlCodeParser(IXMLReaderMediator med) {
      super("code", med);
   }
   ...
   @Override
    public void startElement(
      ...
      med.setCodeLabel(codeLabel);
      System.out.println("XmlCodeParser qName="+qName);
