...
public class FieldEditor extends JTextPane implements ActionListener, DocumentListener {
    ...
    */
    public FieldEditor(String text, int id) {
        super();
        id_ = id;
        type_ = Global.FIELD_TYPE_STRING;
        FieldEditor.this.setContentType("text/plain;charset=UTF-8");
...
//               this.setSelectionEnd(offset);
   ...
   public Object getValue() {
      ...
      if (type_ == Global.FIELD_TYPE_BLOB) {
