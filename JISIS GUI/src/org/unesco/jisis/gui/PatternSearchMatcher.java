...
public class PatternSearchMatcher extends SearchMatcher {
   ...
   //{{{ nextMatch() method
   /**
    * Returns the offset of the first match of the specified text within this
    * matcher.
    *
    ...
    * @param reverse If true find match prior to current match (this is done by
    * searching from the beginning to just prior to the current match, so will
    * be inefficient for large buffers)
    *
