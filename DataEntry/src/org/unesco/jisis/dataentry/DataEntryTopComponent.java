...
public class DataEntryTopComponent extends TopComponent implements Observer {
   ...
   static final String ICON_PATH = "org/unesco/jisis/dataentry/edit.png";
   /** path to the icon used by the component and its open action */
...
//   static final String NEW_PATH = "org/unesco/jisis/dataentry/new.png";
//   static final String SAVE_PATH = "org/unesco/jisis/dataentry/save.png";
//   static final String DEL_PATH = "org/unesco/jisis/dataentry/delete.png";
   ...
   public DataEntryTopComponent(IDatabase db) {
      ...
      setToolTipText(NbBundle.getMessage(DataEntryTopComponent.class, "HINT_DataEntryTopComponent"));
...
//      btnDel.setIcon(new ImageIcon(ImageUtilities.loadImage(DEL_PATH, true)));
    ...
    */
    ...
    private void initComponents() {
        ...
        dataEntryPanelLayout.setHorizontalGroup(
            ...
            .addGroup(dataEntryPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(dataPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 948, Short.MAX_VALUE)
                .addContainerGap())
        );
        dataEntryPanelLayout.setVerticalGroup(
            ...
            .addGroup(dataEntryPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(dataPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblMFN, org.openide.util.NbBundle.getMessage(DataEntryTopComponent.class, "LBL_MFN")); // NOI18N
        ...
        btnFirst.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/unesco/jisis/dataentry/2leftarrow.png"))); // NOI18N
        ...
        btnPrev.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/unesco/jisis/dataentry/1leftarrow.png"))); // NOI18N
        ...
        btnNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/unesco/jisis/dataentry/1rightarrow.png"))); // NOI18N
        ...
        btnLast.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/unesco/jisis/dataentry/2rightarrow.png"))); // NOI18N
        ...
        btnNew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/unesco/jisis/dataentry/new.png"))); // NOI18N
        ...
        btnDel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/unesco/jisis/dataentry/delete.png"))); // NOI18N
        ...
        btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/unesco/jisis/dataentry/save.png"))); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblWKS, org.openide.util.NbBundle.getMessage(DataEntryTopComponent.class, "LBL_WKS")); // NOI18N
        ...
        btnVAL.setToolTipText("Apply the vaidation rules if any");
        ...
        controlPanelLayout.setHorizontalGroup(
            ...
            .addGroup(controlPanelLayout.createSequentialGroup()
                ...
                .addGroup(controlPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(toolbarOptions, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void cmbWKSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbWKSActionPerformed
       // Display current record data with ne WKS
       setRecord(currRec_);
   ...
   private void setRecord(IRecord record) {
      if (record != null) {
         ...
         editPanel_ = new EditPanel(db_, fdt_, wks_, pickListDataList_,
                 validationDataList_, currRec_, showEmptyFields_);
...
//   }
   ...
   public static synchronized DataEntryTopComponent getDefault() throws DefaultDBNotFoundException {
      ...
      if (DatabasePool.getDefaultDatabase() != null) {
         instance = new DataEntryTopComponent(DatabasePool.getDefaultDatabase());
      }
      return instance;
   }
